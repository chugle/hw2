...
table = db.define_table('plugin_uploadify_widget',
    ...
    Field('texts', 'upload', autodelete=True, comment='<- upload a txt file (max file size=1k)'),
    )
...
table.texts.widget = uploadify_widget
table.texts.requires = IS_EMPTY_OR([IS_UPLOADIFY_FILENAME(extension='txt'),
